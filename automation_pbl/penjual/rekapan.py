...
time.sleep(5)
try:
    tombol_rekapan = driver.find_element(By.XPATH, "//a[@href='rekapan.php']")
    tombol_rekapan.click()
    time.sleep(5)

    current_url = driver.current_url

    if 'rekapan.php' in current_url:
        status = "Berhasil"
    ...
    with open("uji-fungsionalitas.txt", "a") as file:
        ...
        file.write(
            f"{waktu_uji} - Fitur Rekapan - Status: {status} \n")
